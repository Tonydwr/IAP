...
public class Leaderboard : MonoBehaviour
{
	...
	public HighscoreUI distance;
	public HighscoreUI score;
	public HighscoreUI historyScore;
	...
	public void Populate()
	{
		...
		historyScore.score.text = PlayerData.instance.highscores[currentHighScore].score.ToString();
		var gs = GameManager.instance.FindState("Game") as GameState;
		distance.score.text = gs.trackManager.worldDistance.ToString();
		// for (int i = 0; i < entriesCount; ++i)
		// {
